...
app.listen(PORT, () => {
  ...
  console.log(`📱 SMS API available at: http://localhost:${PORT}/api/send-sms`)
  console.log(`📧 OTP API available at: http://localhost:${PORT}/api/send-otp`)
  console.log(`📮 Advisory Email API available at: http://localhost:${PORT}/api/send-advisory-email`)
